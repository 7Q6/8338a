...
Taur0000.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0001.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0002.innerText  = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0003.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0004.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0005.innerText  = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0006.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0007.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0008.innerText  = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0009.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0010.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0011.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0012.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0013.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0014.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0015.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0016.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0017.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0018.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0019.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0020.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
...
Taur0021.innerText = '⥱' + ((((bb[id.symbol])/id.total_supply)*100).toFixed(18)) + '⛓%, K¶ ' + ((((bb[id.symbol])*(1/1024)*68.53)*(id.price_usd)).toFixed(8)) + '🌐' + id.name + ': ' + id.percent_change_7d+'% ⟠';
